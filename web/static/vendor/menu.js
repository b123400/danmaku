...
var _user$project$TextMeasure$measureHeight = F2(
	function (f, _p2) {
		return _user$project$TextMeasure$fontSize(f);
	});
var _user$project$TextMeasure$family = function (_p3) {
	var _p4 = _p3;
	return _p4._0;
};
...
var _user$project$Comment$getHeight = function (c) {
	return A2(
		_user$project$TextMeasure$measureHeight,
...
var _user$project$API$apiHost = 'https://danmaku.b123400.net';
