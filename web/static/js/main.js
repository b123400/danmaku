...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML.text("Hello world!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML.text("Why not toggle this button:") ]), Halogen_HTML_Elements_Indexed.button([ Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_(ToggleState.create)) ])([ Halogen_HTML.text((function () {
              ...
              throw new Error("Failed pattern match at Main line 43, column 13 - line 47, column 11: " + [ $4.constructor.name ]);
          })()) ]) ]);
      };
      var $$eval = function (v) {
  ...
  var forceHTMLElement = function (element) {
      var $7 = DOM_HTML_Types.readHTMLElement(Data_Foreign.toForeign(element));
      if ($7 instanceof Data_Either.Left) {
          return Control_Monad_Eff_Exception["throw"](Prelude.show(Data_Foreign.showForeignError)($7.value0));
      };
      if ($7 instanceof Data_Either.Right) {
          return Prelude["return"](Control_Monad_Eff.applicativeEff)($7.value0);
      };
      throw new Error("Failed pattern match at Main line 57, column 3 - line 61, column 1: " + [ $7.constructor.name ]);
  };
  var addOverlay = function (body) {
      var bodyNode = DOM_HTML_Types.htmlElementToNode(body);
      return function __do() {
          var v = Prelude["<$>"](Control_Monad_Eff.functorEff)(Data_Nullable.toMaybe)(DOM_Node_Node.ownerDocument(bodyNode))();
          if (v instanceof Data_Maybe.Just) {
              var newElement = DOM_Node_Document.createElement("div")(v.value0)();
              var v1 = DOM_Node_Element.setId("commentsOverlay")(newElement)();
              var v2 = DOM_Node_Node.appendChild(DOM_Node_Types.elementToNode(newElement))(bodyNode)();
              return forceHTMLElement(newElement)();
          };
          throw new Error("Failed pattern match at Main line 63, column 3 - line 68, column 3: " + [ v.constructor.name ]);
      };
  };
  var main = Halogen_Util.runHalogenAff(Prelude[">>="](Control_Monad_Aff.bindAff)(Halogen_Util.awaitBody)(function (body) {
      return Prelude[">>="](Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(addOverlay(body)))(function (node) {
          return Halogen_Driver.runUI(ui)(initialState)(node);
      });
  }));
  exports["ToggleState"] = ToggleState;
  exports["main"] = main;
  exports["addOverlay"] = addOverlay;
  exports["forceHTMLElement"] = forceHTMLElement;
  exports["ui"] = ui;
