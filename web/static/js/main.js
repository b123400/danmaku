  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML.text("Hello world!") ]), Halogen_HTML_Elements.p_([ Halogen_HTML.text("Why not toggle this button:") ]), Halogen_HTML_Elements_Indexed.button([ Halogen_HTML_Events_Indexed.onClick(Halogen_HTML_Events.input_(ToggleState.create)) ])([ Halogen_HTML.text((function () {
              ...
              throw new Error("Failed pattern match at Main line 39, column 13 - line 43, column 11: " + [ $3.constructor.name ]);
          })()) ]) ]);
      };
      var $$eval = function (v) {
  ...
  var addOverlay = function (body) {
      ...
      return function __do() {
          ...
          if (v instanceof Data_Maybe.Just) {
              ...
              return DOM_Node_Node.appendChild(DOM_Node_Types.elementToNode(newElement))(bodyNode)();
          };
          throw new Error("Failed pattern match at Main line 53, column 3 - line 56, column 3: " + [ v.constructor.name ]);
      };
  };
  var main = Halogen_Util.runHalogenAff(Prelude[">>="](Control_Monad_Aff.bindAff)(Halogen_Util.awaitBody)(function (body) {
      return Prelude[">>="](Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(addOverlay(body)))(function (v) {
          return Halogen_Driver.runUI(ui)(initialState)(body);
      });
  }));
